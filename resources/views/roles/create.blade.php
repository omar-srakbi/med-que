...
@section('page-title', app()->getLocale() === 'ar' ? 'إضافة دور' : 'Add Role')

@section('content')
<div class="card">
    <div class="card-header">
        <i class="bi bi-shield-plus"></i> {{ app()->getLocale() === 'ar' ? 'بيانات الدور' : 'Role Information' }}
    </div>
    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="permissions[]" value="*" id="perm_all">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $perm['value'] }}" id="perm_{{ $perm['value'] }}">
